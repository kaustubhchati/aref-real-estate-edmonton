...
# --- Load 2023 confidential file (oracle: operator-only, skipped on clean clone) ---
...
if (file.exists(conf_path())) {
  ...
  message("Confidential oracle not found (AREF_CONF_PATH unset) — skipping rental-signal validation and bridge-file generation. Expected on a clean clone; set AREF_CONF_PATH in ~/.Renviron to run it.")
}
