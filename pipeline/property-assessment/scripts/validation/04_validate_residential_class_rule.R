...
if (file.exists("data/validation/edmonton_row_labels_2023.csv")) {
  ...
  message("Oracle labels not found (data/validation/edmonton_row_labels_2023.csv) — skipping residential-class validation. Run 03 with AREF_CONF_PATH set to generate it. Expected on a clean clone.")
}
