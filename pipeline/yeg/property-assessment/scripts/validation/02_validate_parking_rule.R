...
if (file.exists(conf_path())) {
  ...
  message("Confidential oracle not found (AREF_CONF_PATH unset) — skipping parking-rule validation. This is expected on a clean clone; set AREF_CONF_PATH in ~/.Renviron to run it.")
}
